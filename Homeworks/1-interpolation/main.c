...
//The values are written into a file linterp.dat. Along with the integral top that point.
    ...
    printf("Task A: Linear spline - Linear interpolation.\n");
    printf("gsl_vectors are used in this exercise.\n"); 
    printf("The linear interpolation function is implemented in linterp.c.\n"); 
    printf("Integration of the linear spline is implemented in linterp_integ.c.\n"); 
    printf("The plot in fig-linterp-pyxplot.png shows the original points, the linear interpolation,\n"); 
	printf("the	linear interpolation integration, and the two GSL routines to comparison.\n");
    printf("\nTask B: Quadratic spline.\n");
    printf("Quadratic spline is implemented in quad.c\n");
    printf("The derivaive and integral are implemented in quad_diff.c and quad_integ.c.\n");
    printf("The plot in fig-quadterp-pyxplot.png shows original points, and the quadratic interpolation, integration and differential.\n");
    printf("\nTask C: Cubic spline.\n");
    printf("Quadratic spline is implemented in cubic.c.\n");
    printf("The derivaive and integral are implemented in cubic_diff.c and cubic_integ.c.\n");
    printf("The plot in fig-cubicterp-pyxplot.png shows the original points, the cubic interpolation, integration and differential,\n");
	printf("together with the GSL routines for comparison.\n");
